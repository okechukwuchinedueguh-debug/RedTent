...
export default function CycleCalendarCard({ month, marks, isLoading, status, onPrevious, onNext, onOpenCycle }: CycleCalendarCardProps) {
  ...
  return <section className="rose-card calendar-card cycle-dashboard-card overflow-hidden p-4 sm:p-6">
    <div className="flex items-start justify-between gap-4"><div><p className="eyebrow">Cycle calendar</p><h2 className="mt-1 font-display text-2xl leading-[1.04] sm:text-3xl">Your cycle, at a glance.</h2></div><div className="cycle-dashboard-card__ornaments" aria-hidden="true"><span className="cycle-dashboard-orbit"><i /></span><span className="calendar-card-ornament" /></div></div>
