...
import { PartnerSupportSettings } from "@/components/PartnerSupportSettings";
...
export default function ProfilePage() {
  ...
  return <div className="mx-auto max-w-3xl px-4 pb-8 pt-5 sm:px-7 lg:px-10 lg:pt-9">
    ...
    <section className="mt-6 grid gap-4 lg:grid-cols-2"><NotificationPreferencesCard /><PartnerSupportSettings /></section>
